...
static void setup_cigar( char * seq_a, char * seq_b, long len_a, long len_b ) {
    gapO = -1;
    gapE = -1;
...
static void teardown_cigar( cigar_p cigar ) {
    free( a_seq.seq );
    free( b_seq.seq );
...
START_TEST (test_generate_cigar_simple_nw)
    {
        ...
        cigar_p cigar = compute_cigar_string( NEEDLEMAN_WUNSCH, a_seq, b_seq, region );
        ...
        cigar = compute_cigar_string( NEEDLEMAN_WUNSCH, a_seq, b_seq, region );
...
START_TEST (test_generate_cigar_simple_sw)
    {
        ...
        cigar_p cigar = compute_cigar_string( SMITH_WATERMAN, a_seq, b_seq, region );
        ...
        cigar = compute_cigar_string( SMITH_WATERMAN, a_seq, b_seq, region );
