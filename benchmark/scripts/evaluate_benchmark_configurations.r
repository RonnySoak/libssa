...
improvement_per_query <- function( query, timing, key1, key2, config_line ) {
    ...
    improvements_func( idx_1, idx_2, mean_timing_query, config_reduced[-c(config_line,4),], "Improvement:" )
}
...
pdf(file='~/projects/master_thesis/tex/img/runtime_per_query_8_16_bit_new.pdf', width = 10, height = 5.5, pointsize = 12)
par( mar=c(5, 5, 3, 2) )
...
pdf(file='~/projects/master_thesis/tex/img/runtime_variation_8_16_bit_new.pdf', width = 8, height = 7, pointsize = 12)
par( mfrow = c(2, 1) )
...
pdf(file='~/projects/master_thesis/tex/img/runtime_variation_64_bit_new.pdf', width = 8, height = 3, pointsize = 12)
